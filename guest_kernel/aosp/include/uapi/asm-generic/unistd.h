...
//prism syscall for secure endpoint and microdroid
#define __NR_pvm_test_syscall 449
__SYSCALL(__NR_pvm_test_syscall, sys_pvm_test_syscall)
//prism syscall for secure endpoint and microdroid
/*
#undef __NR_syscalls
#define __NR_syscalls 449
*/
//chen chen chen  add syscall for microdroid kernel
#undef __NR_syscalls
